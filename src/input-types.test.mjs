...
check(
  ...
  [
    '条件入力の 3 行目（日ごとの営業時刻）の「準備開始」は 08:00 のような時刻で書いてください（今: 8:00）',
    '条件入力の 3 行目（役割と必要人数）の「人数」は 1 以上の整数で書いてください（今: 2 人）',
    '条件入力の 3 行目（調理責任者の学年）の「3年生」は、学年を 1・2・3・4 のどれかの数字で書いてください',
  ],
)
...
check(
  ...
  '条件入力の 3 行目（置き方のルール）の「値」の「1:20」は、30 分単位（1:00・1:30 など）で書いてください',
)
...
check(
  ...
  [1, '条件入力の 4 行目（役割と必要人数）の「人数」は 1 以上の整数で書いてください（今: 2 人）'],
)
